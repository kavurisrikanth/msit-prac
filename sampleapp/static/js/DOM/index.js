function index(){for(var i,n,r=[["a",notes.w_c],["b",notes.b_c]],u=$("white"),f=$("black"),e=$("audio"),t=0;t<notes.w_c.length;t++)
n=document.createElement("div"),n.id="a"+notes.w_c[t]+"d",n.className="w",n.setAttribute("onmousedown","piano.music('a"+notes.w_c[t]+"',1)"),n.setAttribute("onmouseover","piano.chkdsk('a"+notes.w_c[t]+"',1)"),u.appendChild(n);for(t=0;t<notes.b_c.length;t++)
